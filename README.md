...
本课程使用 [codebase-to-course](https://github.com/zarazhangrui/codebase-to-course) 生成：
...
- **Everything Claude Code** - 原始项目 [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code)
- **codebase-to-course** - 生成工具 [zarazhangrui/codebase-to-course](https://github.com/zarazhangrui/codebase-to-course)
- **设计灵感** - 来自 ECC 的温暖设计哲学
...
- GitHub: [@simpletfh](https://github.com/simpletfh)
- 课程问题: 请提交 [Issue](https://github.com/simpletfh/ecc-interactive-course/issues)

---

**Generated with ❤️ using [codebase-to-course](https://github.com/zarazhangrui/codebase-to-course)**
